...
class TestSemanticSimilarityGrader:
    ...
    def test_flexible_field_usage(self, mock_chain_of_thought):
        ...
        grader = SemanticSimilarityGrader(
            pred_field="custom_output",
            ideal_field="custom_reference"
        )
        ...
        mock_evaluator.assert_called_once_with(
            predicted_text="Python is a coding language",
...
class TestFactualAccuracyGrader:
    ...
    def test_accuracy_evaluation(self, mock_chain_of_thought):
        ...
        mock_evaluator.assert_called_once_with(
            generated_response="Paris is France's capital city",
            reference_info="Paris is the capital of France"
        )
        assert score == 0.9
...
class TestCompositeDSPyGrader:
    ...
    def test_composite_scoring(self):
        ...
        graders = {
            "accuracy": (mock_grader1, 0.7),
            "relevance": (mock_grader2, 0.3)
        }
...
class TestConvenienceFunctions:
    ...
    def test_create_qa_grader(self):
        ...
        grader = create_qa_grader(
            answer_field="my_answer",
            question_field="my_question",
            expected_field="my_expected"
        )
